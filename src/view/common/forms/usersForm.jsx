...
export default function UsersForm() {
  ...
  const validationSchema = object({
    ...
    password: string()
      .concat(!user.id ? string().required("Password is required") : null)
    ...
    confirm: string()
      .when("password", (password, schema) => {
        if (!user.id || (resetPassword && user.id))
          return schema.required("Confirm Password");
      })
    ...
    >
      ...
      <form onSubmit={formik.handleSubmit} className="form">
        ...
        >
          ...
          <MenuItem value={"WorkPackeage_Viewer_Only"}>
            WorkPackeage_Viewer_Only
          </MenuItem>
          <MenuItem value={"HeadersOnV_Viewer_Only"}>
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(value) => setResetPassword(value.target.checked)}
              />
            }
